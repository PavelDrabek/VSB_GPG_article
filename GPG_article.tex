...
\begin{align}  
  ...
  D &= b^2-4ac
\end{align}
Získané kvoeficienty $a$, $b$, $c$ z upravené rovnice \eqref{eq:primkakulovaplocha} můžeme dosadit do kvadratické rovnice pro získání parametru $t$.  
\begin{align*}  
  a &= (u_x^2 + u_y^2 + u_z^2)\\
...
\end{enumerate}
Nyní můžeme spočítat parametr $t$. Pokud chceme spočítat průsečík ve směru přímky, musí být parametr $t>=0$. V opačném případě přímka v daném směru kulovou plochu neprotíná.
